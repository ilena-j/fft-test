...
def main():
    ...
    x = 10 * np.cos(2*np.pi * 50e6 * t) # generate sine wave
    ...
    np.savetxt('fft_512_input.txt', u_int16, fmt='%d')  
    ...
    sfft    = np.loadtxt('fft_512_out.txt')
    ...
    sfft    = np.loadtxt('ifft_512_out.txt')
